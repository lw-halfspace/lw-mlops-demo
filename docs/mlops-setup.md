...
git add README.md docs .gitignore lw_mlops_demo/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://adb-1932855278966667.7.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-1932855278966667.7.azuredatabricks.net#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[lw-mlops-demo/databricks.yml](../lw_mlops_demo/databricks.yml) file.
...
Follow the instructions in [lw-mlops-demo/resources/README.md](../lw_mlops_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../lw_mlops_demo/resources/README.md)  to propose, test, and deploy
