...
Opening a pull request will trigger a[workflow](../.github/workflows/lw-mlops-demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-1932855278966667.7.azuredatabricks.net/explore/data/models/staging/lw-mlops-demo/lw-mlops-demo-model)
* [Prod model in UC](https://adb-1932855278966667.7.azuredatabricks.net/explore/data/models/prod/lw-mlops-demo/lw-mlops-demo-model)
. 
